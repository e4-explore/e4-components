...
- The **"Say hello"** button fires a toast.

The bottom-sheet check matters most: it is the native-only `Select` fix that
cannot be verified from a headless bundle or the web build.
